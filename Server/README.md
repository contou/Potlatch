...
by title and duration. In addition, video data must be stored in a Spring Data JPA repository.
...
Clients can upload video metadata (title, duration, etc.) once logged in, 
...
POST /video
   ...
   - A video should not have any points when it is initially created.
...
step to create your submission zip file. Make sure that you take note of the title of the submission
...
```java
        ...
        public MyObject doSomething(
         ...
         // Maybe you want to add this users title to 
