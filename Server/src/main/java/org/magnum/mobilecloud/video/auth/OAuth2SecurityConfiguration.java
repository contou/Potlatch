		...
		public void configure(HttpSecurity http) throws Exception {
            ...
            http
             .authorizeRequests()
                    ...
                    .access("#oauth2.hasScope('register')");
...
//					// video service
//					.withClient("guest").authorizedGrantTypes("password")
//					.authorities("ROLE_CLIENT", "ROLE_TRUSTED_CLIENT")
...
//            UserDetailsService svc = new UserDetailsManager(userDetailsRepository);
//
...
//			return combinedService_;
            return new UserDetailsManager(userDetailsRepository);
		}
