...
** 
*/
package com.cong.potlatch.volley.toolbox.unsafe;
...
import khandroid.ext.apache.http.conn.scheme.LayeredSocketFactory;
...
import khandroid.ext.apache.http.conn.scheme.SocketFactory;
import khandroid.ext.apache.http.entity.HttpEntityWrapper;
import khandroid.ext.apache.http.impl.client.BasicCredentialsProvider;
...
class EasySSLSocketFactory implements SocketFactory, LayeredSocketFactory {
	...
	/**
	 * @see khandroid.ext.apache.http.conn.scheme.SocketFactory#connectSocket(java.net.Socket,
	 *      java.lang.String, int, java.net.InetAddress, int,
	 *      khandroid.ext.apache.http.params.HttpParams)
	 */
	...
	/**
	 * @see khandroid.ext.apache.http.conn.scheme.SocketFactory#createSocket()
	 */
	...
	/**
	 * @see khandroid.ext.apache.http.conn.scheme.SocketFactory#isSecure(java.net.Socket)
	 */
	...
	/**
	 * @see khandroid.ext.apache.http.conn.scheme.LayeredSocketFactory#createSocket(java.net.Socket,
	...
	// -------------------------------------------------------------------
	// javadoc in khandroid.ext.apache.http.conn.scheme.SocketFactory says :
